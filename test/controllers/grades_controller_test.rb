...
class GradesControllerTest < ActionController::TestCase
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post :create, grade: { comments: @grade.comments, essay_id: @grade.essay_id, grader: @grade.grader }
    end
  ...
  test "should update grade" do
    patch :update, id: @grade, grade: { comments: @grade.comments, essay_id: @grade.essay_id, grader: @grade.grader }
    assert_redirected_to grade_path(assigns(:grade))
  end
